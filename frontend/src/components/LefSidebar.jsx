        ...
        <div className='mt-10 mr-3 ' >
            <RouterLink to='/' >
                <button  className='flex hover:bg-gray-900 w-full rounded-md p-2 mb-4'>
                    ...
                    <div className='text-lg ml-3 font-semibold text-white'>Home</div>
                </button>
            </RouterLink>
            ...
            <button className='flex hover:bg-gray-900 w-full rounded-md p-2 mb-4'>
                ...
                <div className='text-lg ml-3 font-semibold text-white'>Search</div>
            </button>
            </RouterLink>
            ...
            <button className='flex hover:bg-gray-900 w-full rounded-md p-2 mb-4'>
                ...
                <div className='text-lg ml-3 font-semibold text-white'>Reels</div>
            </button>
            </RouterLink>

            <RouterLink to='/inbox' >
            <button className='flex hover:bg-gray-900 w-full rounded-md p-2 mb-4'>
                <RiMessengerLine className='text-2xl text-white' />
                <div className='text-lg ml-3 font-semibold text-white'>Messenger</div>
            </button>
            </RouterLink>
            ...
            <button className='flex hover:bg-gray-900 w-full rounded-md p-2 mb-4'>
                ...
                <div className='text-lg ml-3 font-semibold text-white'>Notifications</div>
            </button>
            </RouterLink>
            ...
            <button className='flex hover:bg-gray-900 w-full rounded-md p-2 mb-4'>
                ...
                <div className='text-lg ml-3 font-semibold text-white'>Profile</div>
            </button>
            </RouterLink>
            ...
            <button className='flex hover:bg-gray-900 w-full rounded-md p-2 mb-4'>
                ...
                <div className='text-lg ml-3 font-semibold text-white'>More</div>
            </button>
            </RouterLink>
        </div>
