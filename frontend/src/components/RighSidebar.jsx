    ...
    <div className='w-full px-5' >
      ...
      <div className='flex' >
        ...
        <div>
            {
                data.map((el)=>(
                    <div key={el.id} className='flex justify-between my-3 ' >
                        <div className='flex'>
                            <div className='mr-4 mt-2' >
                                <img className='w-7 h-7 rounded-full' src={el.img}  alt='profile-pic' />
                            </div>
                            <div>
                                <div className='text-white font-bold' >{el.name}</div>
                                <div className='text-gray-400 text-xs ' >{el.username}</div>
                            </div>
                        </div>
